    ...
    <div class="col-8">
      <div v-if="jobHistory">
        <h2 class="jh-entity-heading" data-cy="jobHistoryDetailsHeading">
          <span v-text="$t('pruebaMonoliticaApp.jobHistory.detail.title')">JobHistory</span> {{ jobHistory.id }}
        </h2>
        <dl class="row jh-entity-details">
          ...
          <dd>
            <span v-text="$t('pruebaMonoliticaApp.Language.' + jobHistory.language)">{{ jobHistory.language }}</span>
          </dd>
          <dt>
