...
// prettier-ignore
const Taller = () => import('@/entities/taller/taller.vue');
// prettier-ignore
const TallerUpdate = () => import('@/entities/taller/taller-update.vue');
// prettier-ignore
const TallerDetails = () => import('@/entities/taller/taller-details.vue');
...
export default {
  ...
  children: [
    ...
    },
    {
      path: 'taller/new',
      name: 'TallerCreate',
      component: TallerUpdate,
      meta: { authorities: [Authority.USER] },
    },
    {
      path: 'taller/:tallerId/edit',
      name: 'TallerEdit',
      component: TallerUpdate,
      meta: { authorities: [Authority.USER] },
    },
    {
      path: 'taller/:tallerId/view',
      name: 'TallerView',
      component: TallerDetails,
      meta: { authorities: [Authority.USER] },
    },
